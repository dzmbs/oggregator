...
export function useFlowHistorySummary(underlying: string, venues: string[], range: HistoryRange, enabled = true) {
...
function buildHistoryParams(query: HistoryPageQuery | { underlying: string; venues: string[]; range: HistoryRange }): URLSearchParams {
